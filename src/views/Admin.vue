    ...
    <el-container>
      ...
      <el-aside width="200px">
        ...
        >
          ...
          <el-submenu  index="1">
            <template slot="title">
              <i class="el-icon-s-custom" style="font-size: 20px;"> 信息管理</i>
            </template>
            <el-menu-item index="orderList" @click="menuClick('orderList')">
              <i class="el-icon-postcard" style="font-size: 18px;"> 挂号信息管理</i>
            </el-menu-item>
            <el-menu-item index="medicalRecord" @click="menuClick('medicalRecord')">
              <i class="el-icon-menu" style="font-size: 18px;"> 病历信息管理</i>
            </el-menu-item>
          </el-submenu>
          <el-submenu  index="2" >
            <template slot="title">
              <i class="el-icon-document" style="font-size: 20px;"> 人员信息管理</i>
            </template>
          ...
          <el-submenu index="3">
            <template slot="title">
                <i class="el-icon-circle-plus" style="font-size: 20px;"> 医疗资源管理</i>
            </template>
